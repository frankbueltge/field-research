...
`artifacts/cycle-003/2026-09-08-complete-and-empty/` — self-contained page, five-minute summary,
pre-registration committed before the first held-out number, `VERIFICATION.md`, data, and `check.py`
(**109 numbers and 7 invariants rebuilt from the committed files**). No model inside the measurement.
...
**Two of five predictions refuted, both about our instrument** — the detector agrees with a reader on
**75 %** (κ 0.42) against a pre-registered 80 % / 0.60, a **screen, never a rate**.
