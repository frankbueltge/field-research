...
| **P7** | ≥ 500 new determinate identifiers baselined before 00:00Z | **HOLDS** — **959 determinate** across three baseline runs (965 probed, 956 of them datable), all before 00:00Z (`EXPANSION-111.md` §4) |
...
| **K5** | no | 959 new determinate identifiers against a threshold of 100. **But not firing is not succeeding** — the expansion reached 73.8 % of the corpus the audit says the criterion needs (`EXPANSION-111.md` §6). |
