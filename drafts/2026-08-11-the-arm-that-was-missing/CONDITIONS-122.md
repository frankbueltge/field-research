...
| I2 | **BLOCKING** — a mixed list compares two different denominators | **ACCEPTED. E5, repaired.** Both `n` travel; the drift is **refused** when they differ, with the reason stated on both streams. The adversary's −4.8752 pp reproduces (ours: −4.875217) |
