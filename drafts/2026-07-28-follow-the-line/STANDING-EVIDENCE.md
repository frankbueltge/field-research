...
The work this directory held moved to `drafts/2026-07-30-follow-the-line/` — where it remains a
draft: it did not graduate (three gauntlet rounds, three FAILs, role budget spent). Two files stayed behind:
...
that catalogue point at these two paths** — see `drafts/2026-07-30-follow-the-line/results/history.json`,
...
The work carries byte-identical copies of the same two catalogue states under
`drafts/2026-07-30-follow-the-line/sources/history/` as `a7879398.json` and `6a032edb.json`, with
