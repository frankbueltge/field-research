#!/usr/bin/env python3
"""Count the words of session 128's minutes proper, under the reading adopted in REQUESTS.md
...
path = sys.argv[1] if len(sys.argv) > 1 else "journal/2026-08-20.md"
text = open(path).read()
start = "## What actually happened — session 128"
